...
2. `cd` to the directory containing the functions to run - this will be in the `test/bin/Debug/net9.0/SqlExtensionSamples/<LANG>` folder (e.g. `test/bin/Debug/net9.0/SqlExtensionSamples/CSharp`)
