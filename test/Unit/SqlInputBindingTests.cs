...
namespace Microsoft.Azure.WebJobs.Extensions.Sql.Tests.Unit
{
    public class SqlInputBindingTests
    {
        ...
        public void TestNullConfiguration()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new SqlGenericsConverter<string>(null, loggerFactory.Object));
        }
        ...
        public async void TestWellformedDeserialization()
        {
            ...
            var converter = new Mock<SqlGenericsConverter<TestData>>(config.Object, NullLoggerFactory.Instance);
