...
=======
The SqlAttribute for Trigger bindings takes three [arguments](https://github.com/Azure/azure-functions-sql-extension/blob/main/src/TriggerBinding/SqlTriggerAttribute.cs)
