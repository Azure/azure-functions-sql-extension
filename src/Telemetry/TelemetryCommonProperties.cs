...
namespace Microsoft.Azure.WebJobs.Extensions.Sql.Telemetry
{
    public class TelemetryCommonProperties
    {
        ...
        // IUserLevelCacheWriter userLevelCacheWriter = null)
        {
            ...
            // this._hasher = hasher ?? Sha256Hasher.Hash;
            // this._getMACAddress = getMACAddress ?? MacAddressGetter.GetMacAddress;
            // this._userLevelCacheWriter = userLevelCacheWriter ?? new UserLevelCacheWriter(productVersion);
        }
        ...
        private string GetMachineId()
        {
            ...
            {
                string macAddress = _getMACAddress();
