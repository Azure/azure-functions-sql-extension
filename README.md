...
- Case-sensitive [collations](https://docs.microsoft.com/sql/relational-databases/collations/collation-and-unicode-support#Collation_Defn) are not currently supported. This functionality will be added in a future release. Please track (this)[https://github.com/Azure/azure-functions-sql-extension/issues/133] issue to track progress.
